        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link" href="#">Privacy Poilicy</a>
                    </li>
                    <li class="nav-item mr-3">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <button class="btn btn-outline-success my-2 my-sm-0 px-4 py-2 ml-3" type="submit">Market</button>
                    <button class="btn btn-outline-success my-2 my-sm-0 px-4 py-2 ml-3" type="submit">Sign Up</button>
                </form>
            </div>
    </nav>
